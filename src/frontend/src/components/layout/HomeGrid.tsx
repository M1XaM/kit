  ...
  return (
    <>
      <div className="text-center mb-16">
        <h1 className="text-[clamp(3rem,11vw,6.75rem)] font-extrabold tracking-[-0.04em] leading-none bg-gradient-to-b bg-clip-text text-transparent from-white via-white to-slate-500">
          Kit
        </h1>
        <div className="mx-auto mt-6 max-w-2xl">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-full border px-5 py-3 text-sm transition focus:outline-none focus:ring-2 focus:ring-blue-400/30 border-white/10 bg-white/5 text-slate-200 placeholder:text-slate-500 shadow-none focus:border-blue-400/50"
            />
            {searchQuery ? (
              <button
                type="button"
                className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full border px-3 py-1 text-[0.7rem] font-semibold transition border-white/10 bg-white/10 text-slate-200 hover:border-white/20 hover:bg-white/20"
      ...
      {sections.length ? (
        ...
        <div className="rounded-2xl border p-8 text-center text-sm border-white/10 bg-white/5 text-slate-400 shadow-none">
