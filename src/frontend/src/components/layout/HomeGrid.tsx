  ...
  return (
    <>
      <div className="text-center mb-16">
        <h1 className="hero-title text-[clamp(3rem,11vw,6.75rem)] font-extrabold tracking-[-0.04em] leading-none bg-gradient-to-b from-white via-white to-slate-500 bg-clip-text text-transparent">
          Kit
        </h1>
        <div className="mx-auto mt-6 max-w-2xl">
          ...
          <div className="relative">
            <input
              ...
              className="tool-search w-full rounded-full border border-white/10 bg-white/5 px-5 py-3 text-sm text-slate-200 placeholder:text-slate-500 transition focus:border-blue-400/50 focus:outline-none focus:ring-2 focus:ring-blue-400/30"
            />
            {searchQuery ? (
              <button
                type="button"
                className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full border border-white/10 bg-white/10 px-3 py-1 text-[0.7rem] font-semibold text-slate-200 transition hover:border-white/20 hover:bg-white/20"
